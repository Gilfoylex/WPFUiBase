...
namespace UIBase.Interop
{
    public static class User32
    {
        ...
        /// Delegate declaration that matches native WndProc signatures.
        /// </summary>
        public delegate IntPtr WndProcHook(
            IntPtr hWnd,
            WM uMsg,
            IntPtr wParam,
            IntPtr lParam,
        ...
        [DllImport(Libraries.User32)]
        public static extern bool ScreenToClient(IntPtr hWnd, ref WinDef.POINT lpPoint);
    }
}
