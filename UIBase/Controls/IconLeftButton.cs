...
namespace UIBase.Controls
{
    ...
    public class IconLeftButton : CheckBase
    {
        ...
        //  是否显示图标
        public static readonly DependencyProperty IconVisibilityProperty = DependencyProperty.Register("IconVisibility", typeof(Visibility), typeof(IconLeftButton));
